              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="{{ auth()->user()->admin_profile }}" class="user-image" alt="User Image">
                      <span class="hidden-xs">{{ auth()->user()->admin_name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        ...
                        <p>
                          {{ auth()->user()->admin_name }} - Web Developer
                      ...
                      <li class="user-footer">
                        ...
                        <div class="pull-right">
                          <a href="{{ route('dashboard.admin.logout') }}" class="btn btn-default btn-flat">Sign out</a>
                        </div>
                      </li>
                    </ul>
                  </li>
