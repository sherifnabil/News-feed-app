  ...
  <div class="content-wrapper">
    ...
    <div class="box margin-top ">
      <div class="box-header">
        ...
        <small> <strong>{{ $countries->count() }} </strong> </small>
        <br>        <br>        
          <div class="form-group">
            <form action="{{ route('dashboard.country.index') }}" method="get"  >
              <div class="row">
                <div class="col-md-4">
                  <input type="text" name="search" value="{{ request()->search }}" class="form-control" placeholder="@lang('site.search_country')" >
                </div>
                <button type="submit" class="btn btn-md btn-warning "><i class="fa fa-search"></i> @lang('site.search') </button>
                <a href="{{ route('dashboard.country.create') }}" class="btn btn-primary"> <i class="fa fa-plus"> @lang('site.new')</i> </a>
              </div>
            </form>
          </div>
          </div>
          ...
          <table  class="table table-bordered table-hover">
            <thead  >                  
              <tr class="text-center">
                ...
                <th class="text-center" >@lang('site.country_name')</th>
              ...
              <tbody>
                @foreach ($countries as $country)
                  <tr>  
                    ...
                    <td class="text-center" > <a href=" {{ route('dashboard.country.edit', $country->id) }} " class="btn btn-sm btn-info"> <i class="fa fa-edit"></i> Edit</a> </td>
                    <td class="text-center">
                      <form action="{{ route('dashboard.country.destroy', $country->id) }}" method="post" >
                        {{ csrf_field() }} 
                        {{ method_field('delete') }}
